...
>> By applying this case i think we get better bias values for each bookmaker because our results improved in terms of rates in the last graph. In this case interval 5 and 3 are very well for betting and Expekt also gave very good recommendatiions highly correlated with results.If i bet a game , i probably consider Expekt's recommendations for myself
